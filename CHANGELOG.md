...
- Added opt-in `https.enforce` to require HTTPS and redirect paired HTTP requests with 308 before application hooks. HTTPS-only deployments keep one TLS listener, and existing consumer defaults remain unchanged.
